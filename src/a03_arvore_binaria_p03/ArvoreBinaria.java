...
public class ArvoreBinaria {
	...
	public void travessiaEmPreOrdem(Visitante visitante) {
		travessiaEmPreOrdem(raiz, visitante);
	}
	
	private void travessiaEmPreOrdem(Nodo nodo, Visitante visitante) {
		visitante.visita(nodo);
		
		if (nodo.getEsquerdo() != null) {
			travessiaEmPreOrdem(nodo.getEsquerdo(), visitante);
		}
		if (nodo.getDireito() != null) {
			travessiaEmPreOrdem(nodo.getDireito(), visitante);
		}
	}
